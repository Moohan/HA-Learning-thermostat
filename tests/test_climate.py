...
@patch("custom_components.learning_thermostat.DataCollector")
@patch("custom_components.learning_thermostat.MLCore")
async def test_climate_unique_id(
    mock_ml_core, mock_data_collector, hass: HomeAssistant, mock_config_entry: MockConfigEntry
) -> None:
