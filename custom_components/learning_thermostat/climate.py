...
class LearningThermostat(ClimateEntity, RestoreEntity):
    ...
    @property
    def _data_collector(self) -> DataCollector:
        """Return the data collector."""
        return self._entry.runtime_data.data_collector

    @property
    def _ml_core(self) -> MLCore:
        """Return the ML core."""
        return self._entry.runtime_data.ml_core

    @property
    def _sensor_entities(self) -> list[str]:
        """Return the sensor entities."""
        return self._entry.runtime_data.sensor_entities
